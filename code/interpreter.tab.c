...
#line 244 "interpreter.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 191 "interpreter.y" /* yacc.c:355  */
...
#line 311 "interpreter.tab.c" /* yacc.c:355  */
};
...
#line 328 "interpreter.tab.c" /* yacc.c:358  */
...
{
       0,   239,   239,   239,   247,   250,   260,   270,   275,   280,
     285,   290,   295,   301,   307,   313,   320,   330,   337,   344,
     349,   355,   360
};
#endif
...
#line 250 "interpreter.y" /* yacc.c:1646  */
	...
	strcat(tabs, (yyvsp[0].sVal));
	// get line with correct # of tabs
	(yyval.sVal) = tabs;

	//printf("INDENT x %i line\n", $1);
}
#line 1440 "interpreter.tab.c" /* yacc.c:1646  */
    break;
...
#line 260 "interpreter.y" /* yacc.c:1646  */
    {
		...
		preLineConstruct* p = new preLineConstruct((yyvsp[0].sVal), (yyvsp[-1].iVal));
...
#line 1463 "interpreter.tab.c" /* yacc.c:1646  */
    break;
...
#line 1472 "interpreter.tab.c" /* yacc.c:1646  */
    break;
...
#line 320 "interpreter.y" /* yacc.c:1646  */
    {
			...
			std::string code = formatGetters((yyvsp[0].sVal));
...
#line 365 "interpreter.y" /* yacc.c:1906  */
